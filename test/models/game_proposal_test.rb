...
class GameProposalTest < ActiveSupport::TestCase
  test "no_votes returns proposal_votes where yes_vote is false" do
    ...
    no_vote = proposal_votes(:group_2_game_gta_user_radperson_no) # User 'three' has a no vote in fixtures
  ...
  test "yes_votes returns proposal_votes where yes_vote is true" do
    game_proposal = game_proposals(:group_2_game_gta)
    yes_vote = proposal_votes(:group_2_game_gta_user_cooluserguy_yes) # User 'two' has a yes vote in fixtures
  ...
  test "make_calendar_schedules returns calendar schedules only for sessions in range" do
    ...
    assert_equal [valid_calendar_schedule2, valid_calendar_schedule3].to_set,
      result.to_set,
      "Should return only sessions 2 and 3 from fixtures within the specified range"
  end
  ...
  test "user_voted_yes_or_no? returns true if the user has voted yes or no" do
    ...
    vote = proposal_votes(:group_3_game_thief_user_cooluserguy_undecided)
  ...
  test "update_vote_counts! updates yes_votes_count and no_votes_count" do
    game_proposal = game_proposals(:group_2_game_gta)
    vote_to_change = proposal_votes(:group_2_game_gta_user_radperson_no) # User 'three' has a no vote in fixtures
  ...
  test "get_user_proposal_availability returns the user's proposal availability" do
    ...
    expected_availability = proposal_availabilities(:user_admin_group_1_game_thief_availability)
  ...
  test "user_get_or_build_vote returns the user's vote if it exists" do
    ...
    expected_vote = proposal_votes(:group_2_game_gta_user_cooluserguy_yes)
